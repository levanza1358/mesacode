...
import { type NodeReplRequestMeta, type NodeReplRunResult } from "@mesacode/core/repl";
import { type ComputerUseRuntime } from "@mesacode/cua";
...
export declare const NODE_REPL_MCP_PROCESS_TITLE = "mesacode-node-repl-mcp";
