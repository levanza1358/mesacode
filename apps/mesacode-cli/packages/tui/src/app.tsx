import type { ModelUsageSummary, TodoItem, TurnId } from "@mesacode/contracts";
import { getMesacodeCopy } from "@mesacode/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getMesacodeCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getMesacodeCopy(locale), [locale]);
