...
import { SessionEventType, type SessionEvent } from "@mesacode/contracts";
import type {
...
export type SubagentItem = MesacodeSessionRunningSubagent | MesacodeSessionEndedSubagent;
const EMPTY_DIRECTORY: MesacodeSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
