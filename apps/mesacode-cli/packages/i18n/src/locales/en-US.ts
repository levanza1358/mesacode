...
export const enUS: MesacodeCopy = {
  locale: "en-US",
  cli: {
    errors: {
    ...
    help: (version) => `mesacode ${version}

Usage:
  mesacode [command] [options]

With no command, mesacode opens the full-screen TUI.

Commands:
  app-server Run the Mesacode Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting Mesacode... Ctrl+C to exit",
    },
    transcript: {
      compact: {
