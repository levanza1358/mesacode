// Env Config Adapter - Parse the intentionally small MESACODE_* environment surface.
...
const DEFAULT_PREFIX = "MESACODE_";

/**
 * Parse MESACODE_* environment variables into config
 */
...
export function getToolConcurrencyConfig(): { maxConcurrency: number } {
  return {
    maxConcurrency: normalizeNumber(process.env.MESACODE_MAX_TOOL_CONCURRENCY ?? "10"),
  };
}
