...
import type { Logger, McpOAuthConfig } from "@mesacode/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedMesacodeCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `Mesacode ${this.serverName}`,
