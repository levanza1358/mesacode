...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@mesacode/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-mesacode-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-mesacode-session-type";
