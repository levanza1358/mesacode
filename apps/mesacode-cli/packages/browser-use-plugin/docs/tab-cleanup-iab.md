...
- IAB tabs persist for the lifetime of the current Mesacode process. Turn end, session end, an omitted finalize call,
...
- Mesacode does not restore these tabs after the Mesacode process exits.
