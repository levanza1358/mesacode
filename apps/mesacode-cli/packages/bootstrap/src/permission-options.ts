import type { PermissionOptionsPolicy, PermissionUpdate } from "@mesacode/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type MesacodePermissionOption } from "@mesacode/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 mesacodePermissionUpdateSchema 是 strict，会话语义由
