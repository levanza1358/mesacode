import { mesacodeWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@mesacode/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(mesacodeWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
