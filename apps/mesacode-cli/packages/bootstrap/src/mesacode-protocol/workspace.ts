import { parseRemoteWorkspaceIdentity, type MesacodeWorkspaceRef } from "@mesacode/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): MesacodeWorkspaceRef {
