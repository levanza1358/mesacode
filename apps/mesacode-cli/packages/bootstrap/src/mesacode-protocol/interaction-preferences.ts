import { mesacodeWorkspaceUpdateInteractionPreferencesParamsSchema } from "@mesacode/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(mesacodeWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
