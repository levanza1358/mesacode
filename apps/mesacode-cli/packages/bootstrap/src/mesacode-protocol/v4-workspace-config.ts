...
import { getMesacodeAgentModeSelectOptions, normalizeAvailableMesacodeMode } from "@mesacode/shared";
import type { MesacodeSessionSettingsState, MesacodeSlashCommand } from "@mesacode/shared";
import type { WorkspaceConfigState } from "@mesacode/shared/mesacode-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpMesacodeAgent 的注释）。
