import { mesacodeWorkspaceUpdateModelIoPreferencesParamsSchema } from "@mesacode/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(mesacodeWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
