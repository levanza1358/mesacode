import type { McpTrackedProcess } from "@mesacode/adapters";
import type { MesacodeProcessChildProcessesResult } from "@mesacode/shared";
...
): MesacodeProcessChildProcessesResult {
  return {
