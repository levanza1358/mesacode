import { mesacodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@mesacode/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(mesacodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
