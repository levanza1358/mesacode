...
import type { WorkspaceHookRuntimeAdmissionPort, WorkspaceHookTrustCoordinator } from "@mesacode/core";
import type { WorkspaceHookReviewRequestPayload } from "@mesacode/shared/mesacode-protocol-v4";
