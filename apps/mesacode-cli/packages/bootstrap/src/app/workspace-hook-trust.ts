import { createDefaultFileWorkspaceHookTrustStore } from "@mesacode/adapters/storage";
import {
...
import { SessionEventType } from "@mesacode/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@mesacode/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.mesacode/security。 */
  homeDir?: string;
