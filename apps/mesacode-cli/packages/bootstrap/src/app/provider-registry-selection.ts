import { ModelErrorCode, ModelProtocolError } from "@mesacode/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): MesacodeModelOption {
