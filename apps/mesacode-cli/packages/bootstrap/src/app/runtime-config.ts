...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@mesacode/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@mesacode/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@mesacode/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（Mesacode Protocol session/create 或 CLI
