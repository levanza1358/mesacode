import type { McpServerConfig, PluginLoadOutcome } from "@mesacode/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { MESACODE_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { MESACODE_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
