...
import { SqliteSessionStore } from "@mesacode/adapters/storage";
import { resolvePath, type ConfigResult } from "@mesacode/adapters/config";
import {
...
import type { ModelSelection } from "@mesacode/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("Mesacode SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("Mesacode SQLite migration completed", {
    context: { dbPath },
