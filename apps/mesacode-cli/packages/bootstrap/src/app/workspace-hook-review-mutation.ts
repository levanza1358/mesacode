...
import { digestSummary, workspaceIdentitySummary } from "@mesacode/core";
import {
...
} from "@mesacode/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".mesacode", "config.json");
