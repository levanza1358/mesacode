import type { EmbeddedSearchBackend } from "@mesacode/contracts";
import { getRuntimeToolRuntime } from "@mesacode/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "MESACODE_EMBEDDED_SEARCH_COMMAND";
