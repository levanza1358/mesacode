...
import { BUILTIN_PROVIDER_TEMPLATE_IDS } from "@mesacode/shared";
import { getDefaultConfigPath } from "@mesacode/adapters/config";
import {
...
function importLegacyCliPersonalProviderConfig(
  ...
  // 通用 MesacodeConfigFileSchema 刻意把旧 provider 留在 passthrough unknown，
