...
import { createNodeExecutionAdapter } from "@mesacode/adapters/exec";
...
} from "@mesacode/adapters/workflow";
import {
  AgentRuntime,
...
import type { PrepareUserExecutionBoundary, MesacodeAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "mesacode-expert" : "mesacode-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "mesacode-expert" : "mesacode-workflow",
