...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@mesacode/contracts";
 ...
 *
 *   MesacodeApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
