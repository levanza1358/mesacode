...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@mesacode/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@mesacode/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@mesacode/contracts").MessageId;
      keptMessageIDs?: import("@mesacode/contracts").MessageId[];
      targetMessageID?: import("@mesacode/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@mesacode/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@mesacode/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@mesacode/contracts").SessionId;
