...
// 1. URI ref（mesacode-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
async function mapAttachmentRef(app: MesacodeApp, ref: AttachmentRef): Promise<TurnAttachment> {
