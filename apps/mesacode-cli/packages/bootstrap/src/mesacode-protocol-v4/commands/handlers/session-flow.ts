...
import { createModelExecutionContext } from "../../../mesacode-protocol/model-execution.js";
...
import type { TurnAttachment } from "@mesacode/core";
...
async function stop(
  ...
  host.logger?.info?.("v4 stop foreground execution inspected", {
    ...
    expectedForegroundExecutionId: payload.expectedForegroundExecutionId,
    module: "bootstrap.mesacode_protocol_v4.commands",
...
import { resolveExecutionState } from "@mesacode/shared";
