...
import { RESPOND_TO_COORDINATOR_TOOL_NAME } from "@mesacode/contracts";
import type { SubagentRunOptions } from "@mesacode/contracts";
import {
  defaultScheduler,
  PermissionService,
    ...
    runExploreAgent: async (request, options) => {
      ...
      const childRuntime = new AgentRuntime(
        request.sessionId,
        {
          ...
          agentName: `mesacode-${request.agentType}`,
