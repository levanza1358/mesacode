...
import type { EnvInfo } from "@mesacode/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are Mesacode Explore, a file search and codebase research specialist for Mesacode CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
