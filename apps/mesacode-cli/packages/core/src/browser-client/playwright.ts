...
} from "@mesacode/contracts/browser-control";
...
const locatorDetails = Symbol("mesacode.playwright.locatorDetails");
const setObjectWrapper = Symbol("mesacode.playwright.setObjectWrapper");
