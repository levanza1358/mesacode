...
import type { ModelPropertiesData, ModelOptionSpecsData } from "@mesacode/shared/model-config";

export type { ModelSelection } from "@mesacode/shared/model-selection";
...
} from "@mesacode/shared/model-config";
