...
export const seaOfficialPluginAssetPrefix = "mesacode-official-plugins/";
...
export const officialSeaPlugins = [
  {
    ...
    marketplace: "mesacode-plugins-official",
    name: "node-repl-host",
...
function assertPluginRoot(pluginRoot, plugin) {
  if (!existsSync(join(pluginRoot, ".mesacode-plugin", "plugin.json"))) {
