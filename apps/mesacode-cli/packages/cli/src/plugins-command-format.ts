import { formatJson } from "@mesacode/core";
import type { GlobalOptions, JsonValue, RunContext } from "@mesacode/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly MesacodeAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly MesacodeMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetMesacodePluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetMesacodePluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: MesacodeAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: MesacodeInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: MesacodeMarketplaceSummaryData) {
  return {
    id: marketplace.id,
