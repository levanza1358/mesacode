...
import type { SupportedLocale, UiLocale } from "@mesacode/i18n";
import type { ModelSelection, MesacodeModelOption } from "@mesacode/shared";
import type {
...
export type CommandCenterModelOption = MesacodeModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@mesacode/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@mesacode/tui").TuiReadSubagentTranscript;
