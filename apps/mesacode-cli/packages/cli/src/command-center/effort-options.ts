import { getMesacodeCopy, type UiLocale } from "@mesacode/i18n";
import type { TuiEffortOption } from "@mesacode/tui";
...
export function thoughtLevelsToEffortOptions(
  ...
  const effortCopy = getMesacodeCopy(locale).tui.effort;
