...
import type { runTui } from "@mesacode/tui";
...
const assetPrefix = "mesacode-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@mesacode/tui/dist/index.js";
...
export const loadTuiRuntime = async (): Promise<TuiRuntimeModule> => {
  ...
  if (!sea.isSea()) {
    return await import("@mesacode/tui");
  }
