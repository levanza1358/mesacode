...
This directory contains versioned third-party artifacts required by Mesacode packaging.
...
pnpm --filter @mesacode/desktop prepare:native-search

# Prepare a specific target, optionally into a separate staging directory.
node scripts/prepare-native-search-tools.mjs --platform linux --arch x64 --output-dir /tmp/mesacode-native-search
