...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 mesacodeAgentService 拉取插件 overview */
  getPluginsOverview: IMesacodeAgentService["getPluginsOverview"];
  /** E2E 通过真实 mesacodeAgentService 添加 marketplace */
  addPluginMarketplace: IMesacodeAgentService["addPluginMarketplace"];
  /** E2E 通过真实 mesacodeAgentService 刷新 marketplace */
  updatePluginMarketplace: IMesacodeAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 mesacodeAgentService 安装 marketplace plugin */
  installPlugin: IMesacodeAgentService["installPlugin"];
  /** E2E 通过真实 mesacodeAgentService 触发插件 discover */
  listPlugins: IMesacodeAgentService["listPlugins"];
  /** E2E 通过真实 mesacodeAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IMesacodeAgentService["getPluginReferenceCatalog"];
}
