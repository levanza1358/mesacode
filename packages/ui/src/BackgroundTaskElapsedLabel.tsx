...
function createElapsedBaseline(job: MesacodeBackgroundTaskControlItem) {
  const mountedAt = Date.now();
  return {
    elapsedMs: getMesacodeBackgroundTaskControlItemElapsedMs(job, mountedAt),
...
function elapsedMsForClock(input: {
  ...
  const elapsedFromJob = getMesacodeBackgroundTaskControlItemElapsedMs(input.job, input.now);
