...
import type { V4ConversationFileRewindPreviewResult } from "@mesacode/shared/mesacode-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useMesacodeIntl>["intl"]) {
