...
import { useToolbarConfigOptions } from "@/hooks/useMesacodeConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const modelOption = modelSelectionView?.providers.some((provider) => provider.models.length > 0)
    ? ({
        ...
        currentValue: "",
        options: [],
      } satisfies MesacodeConfigOption)
    : undefined;
  ...
  const thoughtOption = useMemo<MesacodeConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@mesacode/provider";
