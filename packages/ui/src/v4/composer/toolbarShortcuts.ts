...
import type { ShortcutCommandId, MesacodeConfigOption } from "@mesacode/shared";
import {
...
function getChatToolbarShortcutKey(
  category: MesacodeConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: MesacodeConfigOption;
  modeOption?: MesacodeConfigOption;
  thoughtOption?: MesacodeConfigOption;
}
