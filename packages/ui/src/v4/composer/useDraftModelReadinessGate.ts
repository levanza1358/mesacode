...
import { isMesacodeAgentProvider, MESACODE_AGENT_PROVIDER, type MesacodeProvider } from "@mesacode/shared";
import type { IModelSelectionService, ModelSelectionView } from "@mesacode/services";
import {
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isMesacodeAgentProvider(displayProvider);
