...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__mesacodeSessionActivity" as const;
...
export type TaskListMetaWithActivity = MesacodeTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends MesacodeTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: MesacodeTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: MesacodeTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: MesacodeTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: MesacodeTaskMeta,
  membershipTask: MesacodeTaskMeta,
): MesacodeTaskMeta {
