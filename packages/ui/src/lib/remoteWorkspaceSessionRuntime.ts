import type { MesacodeTaskRuntimeStatus } from "@mesacode/shared";
import { getWorkspaceDisplayedTaskState } from "@/store/mesacodeSessionStore.js";
import type { MesacodeSessionStoreState, WorkspaceMesacodeUIState } from "@/store/mesacodeSessionStore.js";
...
interface MarkRemoteWorkspaceRunningTasksFailedParams {
  ...
  getWorkspaceState: MesacodeSessionStoreState["getWorkspaceState"];
  setTaskRuntimeState: MesacodeSessionStoreState["setTaskRuntimeState"];
  reason: string;
}

function isRunningRuntimeStatus(status: MesacodeTaskRuntimeStatus): boolean {
...
function collectRemoteWorkspaceRunningTaskIds(workspaceState: WorkspaceMesacodeUIState): string[] {
