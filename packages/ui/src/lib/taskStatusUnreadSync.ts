...
import type { MesacodeTaskMeta, MesacodeWorkspaceTaskListChanged } from "@mesacode/shared";
...
import { getTaskUnreadIndicator, useMesacodeSessionStore } from "@/store/mesacodeSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IMesacodeTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: MesacodeWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: MesacodeWorkspaceTaskListChanged;
}): boolean {
