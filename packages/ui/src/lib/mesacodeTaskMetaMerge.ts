...
function hasOwnTaskMetaField<T extends keyof MesacodeTaskMeta>(task: MesacodeTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: MesacodeTaskMeta, fallbackTask: MesacodeTaskMeta): string {
...
export function mergeTaskWithOptimisticMeta(
  ...
  optimisticTask: MesacodeTaskMeta,
): MesacodeTaskMeta {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<MesacodeTaskMeta | null | undefined>
): MesacodeTaskMeta | undefined {
  let merged: MesacodeTaskMeta | undefined;
