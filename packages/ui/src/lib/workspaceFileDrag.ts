...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-mesacode-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "mesacode:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "mesacode:workspace-file-drag-state";
