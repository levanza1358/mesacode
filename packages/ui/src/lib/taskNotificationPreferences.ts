const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "mesacode-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "mesacode-notification-sound-enabled";
