...
const MCP_CONFIG_KEY = "mesacode-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "mesacode-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  mesacodeagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "mesacodeagentmcp" && directorySource && directorySource !== "mesacode"
...
export function buildServerList(
  ...
  existingServers: MesacodeMcpServer[],
): MesacodeMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: MesacodeMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: MesacodeMcpServer["file"],
    location?: MesacodeMcpServer["location"],
  ): MesacodeMcpServer {
  ...
  const servers: MesacodeMcpServer[] = [];
...
export function getServerPriority(server: MesacodeMcpServer): number {
