...
import type { ISkillsService } from "@mesacode/services";
...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: MesacodeProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: MesacodeProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToMesacodeAgent(
      hasProvider ? providerOrSkillsService : MESACODE_AGENT_PROVIDER,
    );
