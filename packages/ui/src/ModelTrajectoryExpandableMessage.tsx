import type { MesacodeModelTrajectoryMessage } from "@mesacode/services";
...
type IntlShape = ReturnType<typeof useMesacodeIntl>["intl"];
...
function compactTextPreview(message: MesacodeModelTrajectoryMessage): string {
...
function firstLinePreview(message: MesacodeModelTrajectoryMessage): string {
...
function messageClipboardText(message: MesacodeModelTrajectoryMessage): string {
