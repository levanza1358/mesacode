...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __mesacodeLexicalInputE2E?: typeof bridge }).__mesacodeLexicalInputE2E === bridge
      ) {
        delete (input as { __mesacodeLexicalInputE2E?: typeof bridge }).__mesacodeLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__mesacodeLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
