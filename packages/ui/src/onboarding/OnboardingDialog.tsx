...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useMesacodeStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useMesacodeStore((state) => state.clearOnboardingDialogRequest);
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.mesacode/AGENTS.md",
          },
        ),
