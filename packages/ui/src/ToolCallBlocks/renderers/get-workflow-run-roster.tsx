 ...
 *
 * 一行的读法与模型面
 * （apps/mesacode-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@mesacode/shared/mesacode-protocol-v4";
...
type FormatMessage = ReturnType<typeof useMesacodeIntl>["intl"]["formatMessage"];
