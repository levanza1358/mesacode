...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@mesacode/shared";
...
function isScheduleRule(value: unknown): value is MesacodeAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as MesacodeAutomationScheduleRule)
    : undefined;
