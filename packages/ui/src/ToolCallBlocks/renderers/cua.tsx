...
import type { ApplicationIconRequest } from "@mesacode/shared";
import { useMesacodeIntl } from "@/i18n/IntlProvider.js";
import { isMesacodeCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_mesacode_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isMesacodeCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useMesacodeIntl>["intl"];
