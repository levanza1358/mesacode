...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@mesacode/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteMesacodeAgentService={directoryBrowserServices?.mesacodeAgentService ?? null}
