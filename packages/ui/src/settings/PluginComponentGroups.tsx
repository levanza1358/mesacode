import type { MesacodePluginComponentKind } from "@mesacode/shared";
...
export interface PluginComponentDisplayGroup {
  kind: MesacodePluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<MesacodePluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<MesacodePluginComponentKind, string> = {
