...
function McpServerItem({
  ...
  server: MesacodeMcpServer;
  onEdit: (server: MesacodeMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: MesacodeMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "mesacode";
