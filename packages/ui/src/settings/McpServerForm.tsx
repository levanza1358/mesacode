...
import type { McpSource, MesacodeMcpServer } from "@mesacode/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: MesacodeMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: MesacodeMcpServer) => void;
}) {
  const { intl } = useMesacodeIntl();
