...
import { BUILTIN_MODEL_PROVIDER_IDS } from "@mesacode/shared";
...
function CodingPlanQuotaCards({
  ...
  accountAccess:
    | import("@mesacode/shared").MesacodeProviderAccountAccess
    | import("@mesacode/shared").MesacodeAccountAccess
    | undefined;
            ...
            <div key={card.key} className="min-w-0 flex-1 rounded-xl bg-surface/70 p-4">
              ...
              <div className="flex min-h-5 min-w-0 items-center gap-1">
                ...
                {card.key === "serverMcp" ? (
                  <ControlHintTooltip
                    title={intl.formatMessage({
                      id: "sidebar.usage.plan.mesacodeMcpDescription",
                    })}
                    standalone
                  >
                    <button
                      ...
                      data-mesacode-mcp-info="usage-stats"
                    >
