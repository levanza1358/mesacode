...
export function resolveCodingPlanEntitlementState({
  ...
  accountAvailability?: import("@mesacode/provider").AccountProviderState["availability"];
  accountUnavailableReason?: import("@mesacode/provider").AccountProviderState["unavailableReason"];
      ...
      return [
        {
          ...
          subscriptionRenewTime: null,
          subscriptionExpireTime: null,
          // Team Plan 项目没有可用 mesacode-team-api-key 时，不能继续当作已启用连接方式。
