...
import type {
  ...
  MesacodeImportedSessionSkippedItem,
...
function ImportIssuesList({
  ...
  title: string;
  items: MesacodeImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: MesacodeImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: MesacodeImportSessionsResult | null;
  isImporting: boolean;
