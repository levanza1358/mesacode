...
interface OffPeakEditViewProps {
  editing: MesacodeOffPeakTask | null;
  ...
  onDelete?: (task: MesacodeOffPeakTask) => void;
  onDeleteHistory?: (task: MesacodeOffPeakTask) => void;
  onPause?: (task: MesacodeOffPeakTask) => void;
  onContinue?: (task: MesacodeOffPeakTask) => void;
...
export function OffPeakEditView({
  ...
  const thoughtLevelOption = useMemo<MesacodeConfigOption | null>(
    () =>
    ...
    >
      ...
      {tab === "history" ? (
        <OffPeakHistoryTab
          ...
          {...(onOpenSession
            ? {
                onOpenSession: (task: MesacodeOffPeakTask) =>
                  task.sessionId
                    ? onOpenSession({
