import type { McpServerConfig, MesacodeMcpServer } from "@mesacode/shared";

export const MCP_SECTIONS = ["mesacodeagentmcp"] as const;
...
export function serverToForm(server: MesacodeMcpServer): FormState {
...
// 与 shared 层 convertToMesacodeAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
