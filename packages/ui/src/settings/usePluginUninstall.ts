...
import type { MesacodeInstalledPluginSummary, MesacodePluginInfo } from "@mesacode/shared";
...
interface PluginUninstallController {
  pendingPlugin: MesacodePluginInfo | MesacodeInstalledPluginSummary | null;
