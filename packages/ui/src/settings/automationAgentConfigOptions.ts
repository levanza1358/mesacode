import type { MesacodeConfigOption, MesacodeProvider } from "@mesacode/shared";
...
export function buildAutomationModeOption(currentValue: string): MesacodeConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 mesacode-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: MesacodeConfigOption | undefined,
  currentValue: string,
