...
import type { MesacodePluginMarketplaceSummary } from "@mesacode/shared";
...
function isRemovableMarketplace(marketplace: MesacodePluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<MesacodePluginMarketplaceSummary["refreshFailure"]>;
}) {
