...
import type { MesacodeSavedWorkflowArgType } from "@mesacode/shared";
...
const ARG_TYPES: readonly MesacodeSavedWorkflowArgType[] = ["string", "number", "boolean", "json"];
          ...
          >
            <div className={cn("grid items-center gap-3", columns)}>
              ...
              <Select
                value={row.type}
                onValueChange={(value) =>
                  onChange(row.key, { type: value as MesacodeSavedWorkflowArgType })
                }
              >
