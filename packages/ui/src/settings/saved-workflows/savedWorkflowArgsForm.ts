...
import type { MesacodeSavedWorkflowArgType, MesacodeSavedWorkflowArgsDeclaration } from "@mesacode/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: MesacodeSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: MesacodeSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: MesacodeSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: MesacodeSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: MesacodeSavedWorkflowArgsDeclaration = {};
