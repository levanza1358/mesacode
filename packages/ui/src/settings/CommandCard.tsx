...
import type { UserCommand, MesacodeCommand } from "@mesacode/shared";
import { isPluginCommand, isUserCommand } from "@mesacode/shared";
...
export function isEditableUserCommand(command: MesacodeCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "mesacode";
}

interface CommandCardProps {
  command: MesacodeCommand;
  onEdit?: (command: MesacodeCommand) => void;
  onToggle?: (command: MesacodeCommand, enabled: boolean) => void;
  isOperating?: boolean;
