...
import type { MesacodePluginDiagnostic, MesacodePluginInfo } from "@mesacode/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: MesacodePluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<MesacodePluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<MesacodePluginInfo["hookDetails"]>[number]): string {
