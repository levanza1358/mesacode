 ...
 * Modified by Mesacode: split components and adapt local imports and behavior.
...
import { PromptInputButton } from "./prompt-input-buttons.js";
import type { PromptInputButtonProps } from "./prompt-input-buttons.js";
