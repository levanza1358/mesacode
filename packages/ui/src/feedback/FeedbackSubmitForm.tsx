...
import type { IFeedbackService } from "@mesacode/services";
...
function useActiveFeedbackModelContext(): FeedbackAgentModelContext {
  ...
  return useMemo(
    () => readCurrentAgentModelContext(workspaceMesacodeState?.configOptions),
    [workspaceMesacodeState?.configOptions],
  );
}
