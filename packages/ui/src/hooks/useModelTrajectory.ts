 ...
 *
 * 路径解析与文件读取都收口在 mesacodeTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [mesacodeTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
