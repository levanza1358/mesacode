...
import type { MesacodeAccountAccess, MesacodeProviderAccountAccess } from "@mesacode/shared";

type StableAccountAccess = MesacodeProviderAccountAccess | MesacodeAccountAccess;
