...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@mesacode/shared";
import { useMesacodeAgentService } from "@/hooks/useMesacodeAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useMesacodeAgentService(workspacePath, remoteSessionId, workspaceIdentity);
