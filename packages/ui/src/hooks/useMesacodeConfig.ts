/**
 * Mesacode Agent ConfigOptions 便捷 hooks
 *
...
import type { ConfigOptionsStatus } from "@/store/mesacodeSessionStoreTypes.js";
...
export function useToolbarConfigOptions(
  ...
  const { configOptions, configOptionsStatus } = useMesacodeSessionStore(
    useShallow((state) => {
