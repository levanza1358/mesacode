...
export function useRootPlatformEffects({
  ...
  initialWorkspacePurpose?: import("@mesacode/shared").WorkspacePurpose;
  ...
  isDesktop?: boolean;
  locale: ReturnType<typeof import("@/i18n/IntlProvider.js").useMesacodeIntl>["locale"];
  tabs: WindowTabState[];
  ...
  intl: ReturnType<typeof import("@/i18n/IntlProvider.js").useMesacodeIntl>["intl"];
  ...
  useEffect(() => {
    ...
    const disposeNotificationClick = platform.onTaskNotificationClick((taskId: string) => {
      ...
      const workspaces = useMesacodeSessionStore.getState().workspaces;
  ...
  useEffect(() => {
    ...
    void baseServices.conversationShareService
      ...
      .then((result) => {
        ...
        const sessionStore = useMesacodeSessionStore.getState();
  ...
  useEffect(() => {
    ...
    syncActiveSession();
    return useMesacodeSessionStore.subscribe(syncActiveSession);
