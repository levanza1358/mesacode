...
import type { AccountProviderState } from "@mesacode/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, MesacodeProviderAccountAccess | MesacodeAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: MesacodeProviderAccountAccess | MesacodeAccountAccess =
