...
import { unpackWorkspaceFileEntries } from "@mesacode/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, MesacodeTaskChangeSummary, MesacodeTaskMeta } from "@mesacode/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = MesacodeTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = MesacodeTaskChangeSummary["files"][number];
...
function getTaskTitle(task: MesacodeTaskMeta, untitledLabel: string): string {
