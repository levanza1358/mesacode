import type { MesacodeTaskGroupColor } from "@mesacode/services";
...
const TASK_GROUP_COLOR_CLASS: Record<MesacodeTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<MesacodeTaskGroupColor, string> = {
