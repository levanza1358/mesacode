...
import type { MesacodeGroupedTaskViewNode, MesacodeTaskGroupColor } from "@mesacode/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: MesacodeTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: MesacodeTaskMeta) => string;
  ...
  onUpdateGroupColor: (groupId: string, color: MesacodeTaskGroupColor) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as MesacodeTaskGroupColor);
    },
