import { TID_V4_TASK_OPEN_IN_SPLIT } from "@mesacode/shared";
...
export function TaskActionMenuContent({
  ...
  return (
    <>
      ...
      >
        {/* Mesacode Agent 的日志路径可能先按运行时约定得出，当前日期文件尚未落盘。
      ...
      {onViewModelTrajectory ? (
        <>
          <Separator />
          {/* 调用轨迹查看：从 ~/.mesacode/cli 的 model-io 还原该 task 的模型请求/响应/工具调用，
