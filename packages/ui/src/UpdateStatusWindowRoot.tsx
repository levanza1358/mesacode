import type { IPlatformService, Locale, UpdateStatePayload } from "@mesacode/shared";
import { useCallback, useEffect, useRef, useState } from "react";
import { MesacodeIntlProvider } from "@/i18n/IntlProvider.js";
...
export function UpdateStatusWindowRoot({
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground">
      ...
      <MesacodeIntlProvider key={locale} initialLocale={locale}>
