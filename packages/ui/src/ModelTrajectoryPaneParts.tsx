...
export type IntlShape = ReturnType<typeof useMesacodeIntl>["intl"];
...
export function CallCard({
  ...
  record: MesacodeModelTrajectoryRecord;
  index: number;
  inputMessages: MesacodeModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: MesacodeModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<MesacodeModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<MesacodeModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: MesacodeModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<MesacodeModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
