...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@mesacode/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useMesacodeIntl>["intl"]): string {
  switch (agent) {
    case "mesacode":
      return intl.formatMessage({ id: "settingsSync.agent.mesacode" });
    case "claudeCode":
