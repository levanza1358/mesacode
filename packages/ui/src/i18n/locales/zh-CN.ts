...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 Mesa Code 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 Mesa Code 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Mesa Code 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Mesa Code",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Mesacode。",
  ...
  "startup.global.starting_services": "正在启动 Mesa Code",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Mesacode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Mesacode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 Mesacode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 Mesacode 后重试",
  ...
  "login.title": "欢迎来到 Mesa Code",
  "login.description": "连接账号，开始使用 Mesa Code",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 Mesacode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Mesacode Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 Mesa Code",
  ...
  "titleBar.menu.help.toggleMesacodeStdioTap": "抓取 Agent stdio 通信",
  ...
  "forceUpdate.title": "需要升级 Mesa Code 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Mesacode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Mesacode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.themeMode.black": "纯黑",
  "settings.themeMode.midnight": "午夜",
  "settings.themeMode.ocean": "海洋",
  "settings.themeMode.forest": "森林",
  "settings.themeMode.purple": "紫色",
  "settings.themeMode.rose": "玫瑰",
  "settings.themeMode.amber": "琥珀",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Mesacode 终端的字体覆盖。",
  ...
  "settings.soul.userTitle": "全局 SOUL.md",
  "settings.soul.userDescription":
    "适用于所有工作区的人格设定：身份、语言、语气与工作流偏好。保存到 ~/.mesacode/SOUL.md。它无法覆盖安全策略、工具权限、隐私规则或你在对话中提出的要求。",
  "settings.soul.workspaceTitle": "工作区 SOUL.md",
  "settings.soul.workspaceDescription": "仅适用于当前工作区的人格设定，会叠加在全局 SOUL.md 之上而非替换它。",
  "settings.soul.templateHint": "还没有 SOUL.md。下面是起始模板——保存后才会创建文件。",
  "settings.soul.save": "保存",
  "settings.soul.autoGenerate": "自动生成",
  "settings.soul.generating": "正在生成…",
  "settings.soul.restoreDefaults": "恢复默认",
  "settings.soul.unsaved": "有未保存的修改",
  "settings.soul.saved": "SOUL.md 已保存。",
  "settings.soul.generated": "SOUL.md 草稿已生成。请检查后再保存。",
  "settings.soul.generateFailed": "无法自动生成 SOUL.md。",
  "settings.soul.saveFailed": "保存 SOUL.md 失败。",
  "settings.soul.loadFailed": "读取 SOUL.md 失败。",
  "settings.soul.userEditorLabel": "全局 SOUL.md 内容",
  "settings.soul.workspaceEditorLabel": "工作区 SOUL.md 内容",
  ...
  "settings.mesacodeInteractionBehavior": "交互行为",
  "settings.mesacodeInteractionBehaviorDescription":
    "在 Mesacode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.mesacodeInteractionBehavior.option.queue": "队列",
  "settings.mesacodeInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .mesacode/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Mesacode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Mesacode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Mesacode 总占用",
  ...
  "resourceManager.storage.diskUsage": "Mesacode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Mesacode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Mesacode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Mesacode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Mesacode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 Mesacode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Mesacode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Mesacode Agent 不支持 OAuth 状态刷新。请升级或重启 Mesacode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 Mesacode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Mesacode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 Mesacode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 Mesacode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 Mesacode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Mesacode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Mesacode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.fetchModels": "获取模型",
  "settings.modelProvider.discovery.title": "从供应商获取模型",
  "settings.modelProvider.discovery.description":
    "{provider} 的 /models 接口返回的模型。勾选需要添加的模型，已添加的模型不可再选。",
  "settings.modelProvider.discovery.loading": "正在获取模型列表…",
  "settings.modelProvider.discovery.empty": "该供应商未返回任何模型。",
  "settings.modelProvider.discovery.allAdded": "该供应商的模型已全部添加。",
  "settings.modelProvider.discovery.addSelected": "添加所选（{count}）",
  "settings.modelProvider.discovery.selectAll": "全选",
  "settings.modelProvider.discovery.clearAll": "清空",
  "settings.modelProvider.discovery.configHint":
    "新增模型会优先使用推荐配置，添加后可再逐个微调。",
  "settings.modelProvider.discovery.close": "关闭",
  "settings.modelProvider.discovery.retry": "重试",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Mesacode 即可继续编码。",
  ...
  "sidebar.usage.plan.mesacodeMcpDescription": "Mesacode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Mesacode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Mesacode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Mesacode",
  ...
  "settings.subagents.description": "管理 Mesacode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Mesacode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Mesacode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Mesacode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Mesacode",
  ...
  "settings.commands.description":
    "管理 Mesacode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Mesacode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Mesacode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Mesacode",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .mesacodeignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".mesacodeignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .mesacodeignore",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Mesacode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Mesacode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 Mesacode",
  "onboarding.welcome.start": "开始使用 Mesa Code",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Mesacode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Mesacode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Mesacode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Mesacode 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 Mesacode 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 Mesacode 应用后重试，或让 Mesacode 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Mesacode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Mesacode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 Mesacode 修订后另存一版。",
  ...
  "chat.quota.mcp.quotaExhausted": "Mesacode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Mesacode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  // Mesacode Agent
  "mesacode.unavailable": "AI 代理不可用",
  "mesacode.initFailed": "启动 AI 代理失败",
  "mesacode.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "mesacode.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "mesacode.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "mesacode.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "mesacode.error.providerBusiness.1006": "登录状态已失效，请重新登录后再试。",
  "mesacode.error.providerBusiness.1005":
    "今日免费计划额度已用完。请升级账户、切换模型，或等待额度恢复。",
  "mesacode.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "mesacode.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "mesacode.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "mesacode.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "mesacode.error.providerBusiness.3008": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "mesacode.error.providerBusiness.3009": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "mesacode.error.providerBusiness.3010": "当前系统繁忙，请切换模型、升级账户，或稍后再试。",
  "mesacode.error.providerBusiness.3102": "已超过单次最长运行时间，请创建新的闲时任务继续。",
  "mesacode.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "mesacode.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "mesacode.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Mesacode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "Mesacode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Mesacode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Mesacode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Mesacode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Mesacode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Mesacode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Mesacode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Mesacode 会针对该会话精确验证电脑控制工具。",
