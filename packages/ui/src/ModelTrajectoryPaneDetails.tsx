...
import type { MesacodeModelTrajectoryContentPart, MesacodeModelTrajectoryRecord } from "@mesacode/services";
...
export function ContentPartView({
  ...
  part: MesacodeModelTrajectoryContentPart;
  intl: IntlShape;
  sectionLabel?: string;
...
export function summarizeRecords(records: MesacodeModelTrajectoryRecord[]): {
  totalTokens: number;
  models: string[];
} {
  let totalTokens = 0;
