...
import type { MesacodeModelTrajectoryRecord } from "@mesacode/services";
import {
...
export function resolveTrajectoryTimelineItems(records: MesacodeModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: MesacodeModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: MesacodeModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: MesacodeModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): MesacodeModelTrajectoryRecord["request"]["messages"] {
