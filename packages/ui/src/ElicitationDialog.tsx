...
import type { MesacodeElicitationQuestion, MesacodeElicitationRequest } from "@mesacode/shared";
import type { InteractionAutoResolution } from "@mesacode/shared/mesacode-protocol-v4";
...
interface ElicitationDialogProps {
  request: MesacodeElicitationRequest;
...
interface NormalizedElicitationQuestion extends MesacodeElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: MesacodeElicitationRequest): boolean {
