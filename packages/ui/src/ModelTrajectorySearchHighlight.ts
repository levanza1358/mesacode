...
const HIGHLIGHT_NAME = "mesacode-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "mesacode-model-trajectory-find-active";
const STYLE_ID = "mesacode-model-trajectory-find-highlight-style";
