...
const HOST_ATTRIBUTE = "data-mesacode-pptx-print-host";
const PAGE_ATTRIBUTE = "data-mesacode-pptx-print-page";
const STYLE_ATTRIBUTE = "data-mesacode-pptx-print-style";
