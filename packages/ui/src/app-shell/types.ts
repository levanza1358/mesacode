...
import type { IFeedbackService, IServiceAccessor } from "@mesacode/services";
...
import type { WorkspaceMesacodeUIState } from "@/store/mesacodeSessionStore.js";
...
export interface WorkspaceShellMesacodeState {
  activeTaskId: WorkspaceMesacodeUIState["activeTaskId"];
  draftFocusVersion: WorkspaceMesacodeUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceMesacodeUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceMesacodeUIState["modelSwitchStage"];
  selectedProvider: WorkspaceMesacodeUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceMesacodeUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceMesacodeUIState["workspaceInit"];
...
export type CreateTaskRequest = MesacodeProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@mesacode/shared").RemoteTarget;
    workspaceIdentity?: string;
