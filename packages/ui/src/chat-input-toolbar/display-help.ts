...
export const MESACODE_MODE_OPTION_LABEL_IDS: Record<MesacodeProvider, Record<string, string>> = {
  glm: {
...
export const MESACODE_MODE_OPTION_DESCRIPTION_IDS: Record<MesacodeProvider, Record<string, string>> = {
  glm: {
