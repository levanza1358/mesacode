...
type ContextUsageBreakdownSource = MesacodeContextUsageBreakdownItem["source"];
...
function buildContextUsageBreakdownSegments(
  breakdown: readonly MesacodeContextUsageBreakdownItem[] | undefined,
...
export function getRenderableTaskUsage<T extends { used: number; size: number }>(
  ...
  // Mesacode Protocol 迁移后会单独补齐真实 contextUsed/contextWindow。
...
export function getContextCompressionCommand(_provider: MesacodeProvider): string {
  return "/compact";
}
