import type { Hook, MesacodeWorkspaceHookTrustGrantResult } from "@mesacode/shared";
import type { WorkspaceHookBundleSnapshotData } from "@mesacode/shared/workspace-hook-discovery";
