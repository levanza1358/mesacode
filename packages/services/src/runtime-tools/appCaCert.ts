...
const APP_CA_CERT_FILE = "mesacode-network-ca.pem";
const APP_CA_KEY_FILE = "mesacode-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "Mesacode Network CA" },
    { name: "organizationName", value: "Mesacode" },
  ];
