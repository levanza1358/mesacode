...
export class MesacodeStorageStartupGate {
  private current?: MesacodeStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<MesacodeStorageStartupState>();
  ...
  get snapshot(): MesacodeStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = mesacodeStorageStartupStateSchema.safeParse(input);
