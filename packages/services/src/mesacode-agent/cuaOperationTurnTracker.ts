import { resolveWorkspaceKey, type MesacodeComputerUseOperationEvent } from "@mesacode/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: MesacodeComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: MesacodeComputerUseOperationEvent,
  ): void {
