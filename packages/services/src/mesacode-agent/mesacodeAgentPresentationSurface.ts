import type { ServiceAuthorityMode } from "@mesacode/shared";

export type MesacodeAgentPresentationSurface = "desktop";

interface MesacodeAgentPresentationHostFacts {
...
export function resolveMesacodeAgentPresentationSurface(
  facts: MesacodeAgentPresentationHostFacts,
): MesacodeAgentPresentationSurface | undefined {
