import { requestPluginReferenceCatalog } from "#src/mesacode-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@mesacode/shared";
/* oxlint-disable eslint(max-lines) -- Mesacode Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
import { completeNewModelSelection } from "@mesacode/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  MESACODE_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  MESACODE_AGENT_PROVIDER,
  MESACODE_AGENT_PROVIDER_NOT_READY_CODE,
  MESACODE_AGENT_PROVIDER_NOT_READY_REASON,
  MESACODE_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  MESACODE_PROTOCOL_NAME,
  MESACODE_PROTOCOL_VERSION,
  mesacodeMcpListResultSchema,
  mesacodePermissionRequestParamsSchema,
  mesacodeBrowserListParamsSchema,
  mesacodeBrowserExecuteParamsSchema,
  mesacodePluginsConfigureResultSchema,
  mesacodePluginsInstallResultSchema,
  mesacodePluginsListResultSchema,
  mesacodePluginsMarketplaceMutationResultSchema,
  mesacodePluginsOverviewResultSchema,
  mesacodeProcessChildProcessesResultSchema,
  type MesacodeProcessChildProcess,
  mesacodeSkillsReferenceCatalogResultSchema,
  mesacodeWorkflowsDeleteResultSchema,
  mesacodeWorkflowsGetResultSchema,
  mesacodeWorkflowsListResultSchema,
  mesacodeWorkflowsMoveResultSchema,
  mesacodeWorkflowsRunsResultSchema,
  mesacodeWorkflowsUpdateMetaResultSchema,
  mesacodePluginsResolveSuggestedReferenceResultSchema,
  mesacodePluginOperationProgressNotificationSchema,
  mesacodePluginsRestoreBuiltinResultSchema,
  mesacodePluginsSetEnabledResultSchema,
  mesacodePluginsCancelOperationResultSchema,
  mesacodePluginsUninstallResultSchema,
  mesacodePluginsValidateResultSchema,
  mesacodePluginsDescribeResultSchema,
  mesacodeAutomationCheckTaskBindingParamsSchema,
  mesacodeAutomationCreateParamsSchema,
  mesacodeAutomationDeleteParamsSchema,
  mesacodeAutomationListParamsSchema,
  mesacodeAutomationUpdateParamsSchema,
  mesacodeOffPeakCreateParamsSchema,
  mesacodeOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  mesacodeComputerUseOperationEventSchema,
  mesacodeProviderRuntimeHeadersCancelledSchema,
  mesacodeProviderRuntimeHeadersRequestParamsSchema,
  mesacodeProviderTestModelConnectivityResultSchema,
  mesacodeProviderDiscoverModelsResultSchema,
  mesacodeOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  mesacodeProtocolEmptyResultSchema,
  mesacodeProtocolMethods,
  mesacodeProtocolNotifications,
  mesacodeMcpTelemetryEventSchema,
  mesacodeMcpResourceSamplesSchema,
  mesacodeToolExecResourceSchema,
  mesacodeProcessResourceSampleSchema,
  mesacodeSessionCloseResultSchema,
  mesacodeSessionCompactResultSchema,
  mesacodeSessionEventsResultSchema,
  mesacodeSessionGoalResultSchema,
  mesacodeSessionListResultSchema,
  mesacodeSessionSubagentsResultSchema,
  mesacodeSessionMessagesResultSchema,
  mesacodeSessionEventSchema,
  mesacodeSessionSendResultSchema,
  mesacodeSessionRequestRuntimePreferencesParamsSchema,
  mesacodeSessionRuntimePreferencesResultSchema,
  mesacodeSessionStateSnapshotSchema,
  mesacodeSessionSubscribeResultSchema,
  mesacodeStateUpdatedNotificationSchema,
  mesacodeUserInputRequestParamsSchema,
  mesacodeWorkspacePresentationSchema,
  mesacodeWorkspaceCancelGenerateTextResultSchema,
  mesacodeWorkspaceGenerateTextResultSchema,
  mesacodeWorkspaceHookTrustGrantResultSchema,
  mesacodeWorkspaceUpdateInteractionPreferencesResultSchema,
  mesacodeWorkspaceUpdateModelIoPreferencesResultSchema,
  mesacodeProviderUpdateAccountConfigResultSchema,
  type MesacodeSessionStateSnapshot,
  type MesacodeAutomation,
  type MesacodeAutomationRun,
  mesacodeWorkspaceUpdateOffPeakToolPolicyResultSchema,
  mesacodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  ...
  type MesacodeToolExecResource,
  type MesacodePluginOperationProgressNotification,
  type MesacodeTaskMode,
} from "@mesacode/shared";
...
} from "#src/mesacode-agent/automationToolPolicy.js";
import { MESACODE_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./mesacodeAgent.js";
import type {
  MesacodeProtocolRequestId,
  ModelSelection,
  MesacodeProviderRuntimeHeadersRequestParams,
  MesacodeSessionEvent,
  MesacodeSessionRuntimePreferencesScope,
  MesacodeSavedWorkflowScope,
  MesacodeStateUpdatedNotification,
  MesacodeWorkspacePresentation,
  MesacodeWorkspaceRef,
  MesacodeSessionRuntimePreferencesResult,
} from "@mesacode/shared";
import type {
  IMesacodeAgentService,
  MesacodeAgentBackgroundBashOutputParams,
  MesacodeAgentAppRuntimePreferences,
  MesacodeAgentRuntimeLifecycleEvent,
  MesacodeAgentAddPluginMarketplaceParams,
  MesacodeAgentAppUsageParams,
  MesacodeAgentCancelPluginOperationParams,
  MesacodeAgentCompactParams,
  ...
  MesacodeAgentGenerateWorkspaceTextParams,
  MesacodeAgentTestModelConnectivityParams,
  MesacodeAgentDiscoverModelsParams,
  MesacodeAgentGoalParams,
  MesacodeAgentGrantWorkspaceHookTrustParams,
  MesacodeAgentInitializeResult,
  MesacodeAgentListSessionsParams,
  MesacodeAgentListSessionSubagentsParams,
  MesacodeAgentReadWorkspacePresentationParams,
  MesacodeAgentReadSessionEventsParams,
  MesacodeAgentReadSessionMessagesParams,
  MesacodeAgentReadSessionParams,
  MesacodeAgentRemovePluginMarketplaceParams,
  MesacodeAgentRespondSessionRuntimePreferencesParams,
  ...
  MesacodeAgentSessionRuntimePreferencesRequest,
  MesacodeAgentTaskTokenUsageParams,
  ...
  MesacodeAgentAttachmentReadParams,
  MesacodeAgentConversationAttachmentReadParams,
  MesacodeAgentConversationAttachmentStatParams,
  MesacodeAgentAttachmentPreviewSourceParams,
  MesacodeAgentAttachmentTerminalParams,
  MesacodeAgentConversationCommandParams,
  MesacodeAgentCommandsQueryParams,
  MesacodeAgentConversationFileChangesParams,
  MesacodeAgentConversationFileRewindPreviewParams,
  MesacodeAgentConversationRowsRangeParams,
  MesacodeAgentConversationPlansParams,
  MesacodeAgentConversationWorkflowRunEventsParams,
  MesacodeAgentConversationWorkflowRunArtifactDataParams,
  MesacodeAgentConversationWorkflowRunArtifactReadParams,
  MesacodeAgentConversationWorkflowRunArtifactsParams,
  MesacodeAgentConversationWorkflowRunNodeResultParams,
  MesacodeAgentConversationWorkflowRunWorkspaceParams,
  MesacodeAgentConversationWorkflowRunsParams,
  MesacodeAgentConversationResyncParams,
  MesacodeAgentConversationSubscribeParams,
  MesacodeAgentConversationUnsubscribeParams,
  MesacodeAgentConnectionFlowParams,
  MesacodeAgentSessionsIndexSubscribeParams,
  MesacodeAgentWorkspaceConfigSubscribeParams,
} from "./mesacodeAgent.js";
import {
  ...
  utf8JsonByteLength,
  MESACODE_ATTACHMENT_FAULT_CODES,
  MesacodeAttachmentFaultError,
  type CommandAck,
...
import {
  ...
  readTrustedMesacodeAgentV4UnsubscribeRoute,
} from "./mesacodeAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/mesacode-agent/mesacodeSessionEventCoalescer.js";
...
import { MesacodeAgentMcpStatusModeUnsupportedError } from "#src/mesacode-agent/mesacodeAgentErrors.js";
import { MesacodeAgentProcessManager } from "./mesacodeAgentProcessManager.js";
import type { MesacodeAgentProcessManagerOptions } from "./mesacodeAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  MesacodeProtocolRequestTimeoutError,
  type MesacodeProtocolClient,
} from "./mesacodeProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./mesacodeAgentBrowserAmbientContext.js";
import {
...
import type { PipSessionEvent } from "@mesacode/cua/pip-session";
import { registerMemoryDiagnosticsProvider } from "#src/memoryDiagnostics.js";

const logger = createServiceLogger("mesacode-agent-service");
...
interface PendingPermissionRequest {
  client: MesacodeProtocolClient;
  protocolRequestId: MesacodeProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: MesacodeProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: MesacodeAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "Mesacode agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: MesacodeAgentWorkspaceTarget): MesacodeWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: MesacodeAgentSavedWorkflowTarget,
): params is MesacodeAgentWorkspaceTarget & { scope?: MesacodeSavedWorkflowScope } {
  return typeof (params as Partial<MesacodeAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: MesacodeAgentSavedWorkflowTarget): {
  scope?: MesacodeSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".mesacode", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the Mesacode Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.mesacode/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when mesacode-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__mesacode-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof MesacodeProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `Mesacode Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: MesacodeAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: MesacodeAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: MesacodeAgentSendPromptParams,
...
function buildSessionCompactParams(params: MesacodeAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${MESACODE_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: MesacodeAgentSessionTarget): string {
...
function permissionRequestKey(params: MesacodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: MesacodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: MesacodeAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface MesacodeAgentProviderReadinessSnapshot {
...
): MesacodeAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: MesacodeAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: MesacodeAgentWorkspaceTarget): Error & {
  code: typeof MESACODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("Mesacode Agent runtime is not running.") as Error & {
    code: typeof MESACODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = MESACODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateMesacodeAgentServiceOptions extends Omit<
  MesacodeAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: MesacodeSessionRuntimePreferencesScope,
  ) => Promise<MesacodeSessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: MesacodeAutomation;
    run: MesacodeAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: MesacodeAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<MesacodeProtocolClient, "respondError">,
  request: { id: MesacodeProtocolRequestId; method: string },
  workspace: MesacodeAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createMesacodeAgentService(
  options?: CreateMesacodeAgentServiceOptions,
): IMesacodeAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new MesacodeAgentProcessManager(options);
  ...
  const pluginProcessManager = new MesacodeAgentProcessManager({
  ...
  const mcpStatusProcessManager = new MesacodeAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<MesacodeAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<MesacodeAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<MesacodeToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<MesacodeMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<MesacodeMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<MesacodePluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<MesacodeAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<MesacodeProtocolClient>();
  const clientDisposables = new WeakMap<MesacodeProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: MesacodeAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<MesacodeProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<MesacodeProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: MesacodeProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "Mesacode provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "Mesacode provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "mesacode_agent.runtime_preferences.host_response_timeout",
      module: "services.mesacode_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: MESACODE_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          mesacodeProtocolMethods.providerUpdateAccountConfig,
          {
            revision: snapshot.revision,
            basedOnMesacodeBuiltinRevision: snapshot.basedOnMesacodeBuiltinRevision,
        ...
        logger.info(undefined, "account provider config 已交付到 Mesacode agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: MesacodeProtocolClient;
    preferences: MesacodeAgentAppRuntimePreferences;
    workspace: MesacodeAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          mesacodeProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            mesacodeProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: MesacodeAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 Mesacode agent", {
  ...
  function getSessionEmitter(params: MesacodeAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<MesacodeAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<MesacodePluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: MesacodeAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: MesacodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: MesacodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: MesacodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedMesacodeAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: MesacodeAgentConversationUnsubscribeParams | MesacodeAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedMesacodeAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: MesacodeAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: MesacodeAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function emitSessionEvent(
    workspace: MesacodeAgentWorkspaceTarget,
    sessionId: string,
    event: MesacodeAgentServiceEvent,
  ): void {
  ...
  function handleStateUpdated(
    workspace: MesacodeAgentWorkspaceTarget,
    notification: MesacodeStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === mesacodeProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = mesacodeProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === mesacodeProtocolNotifications.processResourceSample) {
          const parsed = mesacodeProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 Mesacode CLI 资源样本", {
        ...
        if (message.method === mesacodeProtocolNotifications.toolExecResource) {
          const parsed = mesacodeToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === mesacodeProtocolNotifications.mcpResourceSamples) {
          const parsed = mesacodeMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === mesacodeProtocolNotifications.mcpTelemetry) {
          const parsed = mesacodeMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 Mesacode CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === mesacodeProtocolNotifications.pluginOperationProgress) {
          const parsed = mesacodePluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 Mesacode Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === mesacodeProtocolMethods.computerUseOperationEvent) {
          const parsed = mesacodeComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 Mesacode Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = mesacodeSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 Mesacode Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = mesacodeStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === mesacodeProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = mesacodeSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: MesacodeSessionRuntimePreferencesResult;
              try {
                preferences = mesacodeSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: MesacodeAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "mesacode_agent.runtime_preferences.host_request_dispatched",
            module: "services.mesacode_agent",
            requestId,
        ...
        if (request.method === mesacodeProtocolMethods.interactionRequestPermission) {
          const parsed = mesacodePermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === mesacodeProtocolMethods.interactionRequestUserInput) {
          const parsed = mesacodeUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = mesacodeProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 Mesacode provider runtime headers 请求", {
        ...
        if (request.method === mesacodeProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = mesacodeOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.interactionBrowserList) {
          const parsed = mesacodeBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.interactionBrowserExecute) {
          const parsed = mesacodeBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.automationCreate) {
          const parsed = mesacodeAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.offPeakCreate) {
          const parsed = mesacodeOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.offPeakList) {
          const parsed = mesacodeOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.automationList) {
          const parsed = mesacodeAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.automationCheckTaskBinding) {
          const parsed = mesacodeAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.automationUpdate) {
          const parsed = mesacodeAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === mesacodeProtocolMethods.automationDelete) {
          const parsed = mesacodeAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported Mesacode Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: MesacodeAgentSessionTarget,
  ...
  function getSessionTraceId(target: MesacodeAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof MESACODE_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof MESACODE_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = MESACODE_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: MESACODE_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof MESACODE_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === MESACODE_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    MesacodeAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 Mesacode Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: MesacodeAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          mesacodeProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          mesacodeProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          mesacodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 Mesacode agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: MesacodeAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，Mesacode agent 保持只读"
            : "provider/model 尚未就绪，Mesacode agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 Mesacode agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<MesacodeProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.mesacode/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: MesacodeAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveGlobalSavedWorkflowCarrier(): Promise<{
    client: MesacodeProtocolClient;
    workspace: MesacodeWorkspaceRef;
  }> {
  ...
  async function resolveSavedWorkflowCarrier(
    params: MesacodeAgentSavedWorkflowTarget,
  ): Promise<{ client: MesacodeProtocolClient; workspace: MesacodeWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<MesacodeProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: MesacodeAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: MesacodeAgentWorkspaceTarget): Promise<MesacodeAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 Mesacode agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "Mesacode agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: MESACODE_PROTOCOL_NAME,
          protocolVersion: MESACODE_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "Mesacode agent 等待 provider/model 就绪" : "Mesacode agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: MESACODE_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: MesacodeAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: MesacodeAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: MesacodeAgentWorkspaceTarget) {
    ...
    async createSession(params: MesacodeAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 Mesacode Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          mesacodeProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "Mesacode Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "Mesacode Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "Mesacode Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "Mesacode Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          mesacodeProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "Mesacode Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: MesacodeAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 Mesacode Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          mesacodeProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "Mesacode Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "Mesacode Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "Mesacode Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "Mesacode Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: MesacodeAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        mesacodeProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: MesacodeAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        mesacodeProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: MesacodeAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: MesacodeAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: MesacodeAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        mesacodeProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: MesacodeAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        mesacodeProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        mesacodeProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: MesacodeAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        mesacodeProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: MesacodeAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 Mesacode Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: MesacodeWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              mesacodeProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              mesacodeWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("Mesacode Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "Mesacode Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "Mesacode Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: MesacodeAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: MesacodeAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new MesacodeAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, mesacodeProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: MesacodeAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          mesacodeProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, mesacodeProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: MesacodeAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: MesacodeAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        mesacodeProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: MesacodeAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        mesacodeProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        mesacodeWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: MesacodeAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        mesacodeProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        mesacodeWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: MesacodeAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        mesacodeProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        mesacodeWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: MesacodeAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        mesacodeProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        mesacodeWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: MesacodeAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        mesacodeProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: MesacodeAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        mesacodeProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        mesacodeWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: MesacodeAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: MesacodeProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              mesacodeProtocolMethods.processChildProcesses,
              {},
              mesacodeProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: MesacodeAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: MesacodeAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: MesacodeAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: MesacodeAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: MesacodeAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: MesacodeAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        mesacodePluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: MesacodeAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: MesacodeAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: MesacodeAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: MesacodeAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: MesacodeAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: MesacodeAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: MesacodeAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: MesacodeAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        mesacodeProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: MesacodeAgentWorkspaceTarget) {
    ...
    async createAutomation(params: MesacodeAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as MesacodeTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: MesacodeAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as MesacodeTaskMode | undefined),
    ...
    async deleteAutomation(params: MesacodeAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: MesacodeAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: MesacodeAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: MesacodeAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: MesacodeAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: MesacodeAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: MesacodeAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 Mesacode Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            mesacodeProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            mesacodeWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          mesacodeProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: MesacodeAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        mesacodeProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async discoverModels(params: MesacodeAgentDiscoverModelsParams) {
      const client = await getClient(params);
      ...
      return client.request(
        mesacodeProtocolMethods.providerDiscoverModels,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async sendPrompt(params: MesacodeAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: MesacodeAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "Mesacode Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          mesacodeProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          mesacodeSessionSendResultSchema,
        );
        logger.info(logTraceId, "Mesacode Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "Mesacode Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "Mesacode Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: MesacodeAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "Mesacode Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          mesacodeProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "Mesacode Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "Mesacode Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: MesacodeAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 Mesacode Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          mesacodeProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "Mesacode Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "Mesacode Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: MesacodeAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        mesacodeProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: MesacodeAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 Mesacode Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          mesacodeProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "Mesacode Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "Mesacode Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: MesacodeAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        mesacodeProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: MesacodeAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        mesacodeProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "mesacode_agent.runtime_preferences.response_without_pending",
          module: "services.mesacode_agent",
          requestId: params.requestId,
        });
        throw new Error(`Mesacode session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "mesacode_agent.runtime_preferences.host_response_received",
        module: "services.mesacode_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: MesacodeAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: MesacodeAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: MesacodeAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              mesacodeProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("mesacode-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: MesacodeAgentConnectionFlowParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: MesacodeAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。Mesacode Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: MesacodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: MesacodeAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: MesacodeAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedMesacodeAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // Mesacode Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: MesacodeAgentCommandsQueryParams) {
      if (!readTrustedMesacodeAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: MesacodeAgentAttachmentBeginParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: MesacodeAgentAttachmentChunkParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: MesacodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: MesacodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: MesacodeAgentAttachmentReadParams) {
      if (!readTrustedMesacodeAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: MesacodeAgentConversationAttachmentReadParams) {
      if (!readTrustedMesacodeAgentV4Connection(params)) {
        throw new MesacodeAttachmentFaultError(
          MESACODE_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: MesacodeAgentConversationAttachmentStatParams) {
      if (!readTrustedMesacodeAgentV4Connection(params)) {
        throw new MesacodeAttachmentFaultError(
          MESACODE_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: MesacodeAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: MesacodeAgentConversationRowsRangeParams) {
      const trusted = readTrustedMesacodeAgentV4Connection(params);
    ...
    async conversationPlansV4(params: MesacodeAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: MesacodeAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: MesacodeAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: MesacodeAgentBackgroundBashOutputParams) {
      if (!readTrustedMesacodeAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: MesacodeAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: MesacodeAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: MesacodeAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: MesacodeAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: MesacodeAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: MesacodeAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: MesacodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: MesacodeAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: MesacodeAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: MesacodeAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: MesacodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: MesacodeAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: MesacodeAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: MesacodeAgentRuntimeLifecycleEvent) => void) {
