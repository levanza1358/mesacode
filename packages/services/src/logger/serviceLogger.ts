import { formatLogPrefix, type TraceId } from "@mesacode/shared";
...
export function createServiceLogger(
  ...
  function write(
    ...
    // 服务层日志过去常被复用到 Mesacode Agent 命名 logger，导致新 Mesacode 路径继续依赖 Mesacode Agent 目录。
    // 这里把通用分级日志抽到独立模块，后续删除 Mesacode Agent runtime 时不会牵连非 Mesacode Agent 服务。
