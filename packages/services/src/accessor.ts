...
import type { IMesacodeTaskService } from "./session/mesacodeTaskService.js";
import type { IMesacodeAgentService } from "./mesacode-agent/mesacodeAgent.js";
import type { IMesacodeSessionService } from "./mesacode-session/mesacodeSession.js";
...
export interface IServiceAccessor {
  ...
  /** 设置页插件管理（UI 不再直触 mesacodeAgentService 的 plugins/* 面） */
