...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@mesacode/cua/broker/server";
...
/**
 * Parse a `mesacode-cua-windows-dev/v1` control message from the helper child.
 *
