...
// @mesacode/cua as part of the single-package merge. This file preserves
...
//
// Why two layers:
//   - `@mesacode/cua/broker/server` (51 server files) — broker server +
...
//   - `@mesacode/cua/broker` (protocol) — brokerProtocol / helperErrors /
...
export * from "@mesacode/cua/broker/server";
