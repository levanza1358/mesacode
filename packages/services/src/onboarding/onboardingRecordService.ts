...
import { onboardingRecordFileSchema } from "@mesacode/shared";
import { appSettingsOccupationEnum } from "@mesacode/shared";
import type {
...
function getRecordFile(): string {
  // 记录是设备级数据，必须跟随 dataBaseDir（用户自定义数据目录时落在其 .mesacode/v2 下，
