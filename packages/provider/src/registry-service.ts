...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnMesacodeBuiltinRevision !== config.mesacodeBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          mesacodeBuiltinProviders: config.mesacodeBuiltinProviders,
          mesacodeBuiltinProviderTemplates: config.mesacodeBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          mesacodeBuiltinModelRules: config.mesacodeBuiltinModelRules,
