declare module "*.css";
declare module "@mesacode/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_MESACODE_BASE_URL?: string;
  readonly VITE_MESACODE_ENDPOINT_ORIGIN?: string;
  readonly VITE_MESACODE_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
