...
// Vite 配置在 Node 加载期执行，不能导入 @mesacode/shared 根入口。
...
} from "@mesacode/shared/mesacodeEndpoint";
...
export default defineConfig(({ mode }) => {
  ...
  const mesacodeEndpointOrigin = resolveRuntimeMesacodeEndpointOrigin(endpointEnv);
