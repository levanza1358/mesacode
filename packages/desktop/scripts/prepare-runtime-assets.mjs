...
const shouldSkipRemoteAssets = process.env.MESACODE_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (MESACODE_SKIP_REMOTE_ASSETS=1)");
}
