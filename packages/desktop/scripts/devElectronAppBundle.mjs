...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "mesacode";
export const DEV_ELECTRON_APP_NAME = "Mesacode Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.mesacode.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 mesacode URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 mesacode 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".mesacode-dev-electron-source.json");
