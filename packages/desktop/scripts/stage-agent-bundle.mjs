// Agent bundle 的暂存动作：把 apps/mesacode-cli/packages/cli/dist/mesacode.cjs 放进
...
// desktopRuntimeEnv.ts 的 resolveBundledMesacodeAgentBinaryPath() 解析，候选**只有**
...
export const AGENT_BUNDLE_SOURCE_RELATIVE = "apps/mesacode-cli/packages/cli/dist/mesacode.cjs";
...
export function resolveAgentBundlePaths({ repoRoot, platformKey }) {
  ...
  return {
    ...
    glmDir,
    stagedBundlePath: resolve(glmDir, "mesacode.cjs"),
 ...
 * （mesacode-agent / mesacode-acp 等）和旧 meta 会被一并打进安装包（CI 干净检出不会有，本地会）。
 */
