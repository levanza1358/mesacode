...
import type { ApplicationIconInfo } from "@mesacode/shared";
...
public static class MesacodeAumidIcon {
...
'@;
$mesacodeIconBytes=[MesacodeAumidIcon]::Read($mesacodeArg0);
[Console]::Out.Write([Convert]::ToBase64String($mesacodeIconBytes));
`;
