...
export function reportMcpTelemetryToArms(
  event: MesacodeMcpTelemetryEvent,
...
function mapMcpTelemetryEvent(event: Exclude<MesacodeMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<MesacodeMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
