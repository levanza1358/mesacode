...
import { HELPER_APP_NAME } from "@mesacode/cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@mesacode/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.MESACODE_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
