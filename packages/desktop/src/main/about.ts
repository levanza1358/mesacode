...
const ABOUT_APPLICATION_NAME = "Mesa Code Desktop App";
...
> = {
  "zh-CN": {
    aboutTitle: "关于 Mesa Code",
    versionLabel: "版本",
    okButtonLabel: "确定",
    optimizedForAppleSilicon: "已针对 Apple Silicon 优化。",
    copyright: (year) => `版权所有 © ${year} Mesa Code。`,
  },
  "en-US": {
    aboutTitle: "About Mesa Code",
    versionLabel: "version",
    okButtonLabel: "OK",
    optimizedForAppleSilicon: "Optimized for Apple Silicon.",
    copyright: (year) => `Copyright © ${year} Mesa Code.`,
  },
};
