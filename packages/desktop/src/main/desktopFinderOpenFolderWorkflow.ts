...
const WORKFLOW_NAME = "Open in Mesa Code.workflow";
const WORKFLOW_BUNDLE_ID = "dev.mesacode.app.finder-open-workflow";
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "mesacode://workspace/open?path=\${encoded}"
fi
`;
