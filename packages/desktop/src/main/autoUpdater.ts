...
import type { ISettingService } from "@mesacode/services";
import {
  DEFAULT_LOCALE,
...
const UPDATE_FEED_URL_ENV = "MESACODE_UPDATE_FEED_URL";
const UPDATE_FEED_URL_SWITCH = "--mesacode-update-feed-url";
const DEV_AUTO_UPDATE_ENV = "MESACODE_AUTO_UPDATE_DEV";
const DEV_AUTO_UPDATE_SWITCH = "--mesacode-auto-update-dev";
const DEV_AUTO_UPDATE_VERSION_ENV = "MESACODE_AUTO_UPDATE_DEV_VERSION";
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--mesacode-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  mesacodeReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.mesacodeReleaseChannel === "preview" || info.mesacodeReleaseChannel === "stable"
    ? info.mesacodeReleaseChannel
    : null;
}
...
function applyManifestUpdateProvider(options: InitAutoUpdaterOptions): void {
  ...
  autoUpdater.setFeedURL({
    ...
    resolveEndpointOrigin:
      options.resolveEndpointOrigin ?? (() => resolveRuntimeMesacodeEndpointOrigin(process.env)),
