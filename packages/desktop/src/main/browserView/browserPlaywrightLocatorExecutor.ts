...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@mesacode/shared";
...
const PLAYWRIGHT_WORLD_NAME = "mesacode-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__mesacodePlaywrightInjected";
