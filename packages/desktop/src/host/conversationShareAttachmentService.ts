import { Event as RpcEvent } from "@mesacode/rpc";
import type { IConversationShareService, IMesacodeAgentService } from "@mesacode/services";
import { conversationShareConnectionScopeFactory } from "@mesacode/services/node";
