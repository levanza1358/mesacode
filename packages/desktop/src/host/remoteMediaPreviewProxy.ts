...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@mesacode/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@mesacode/shared";
import {
...
const MEDIA_ROUTE_PREFIX = "/__mesacode_media/";
