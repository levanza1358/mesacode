...
import { MESACODE_AGENT_RUNTIME_UNAVAILABLE_CODE, type IMesacodeAgentService } from "@mesacode/services";
import {
  PROTOCOL_V4_LIMITS,
  sessionsIndexTopic,
...
> &
  Partial<Pick<IMesacodeAgentService, "onAgentRuntimeLifecycle">>;
