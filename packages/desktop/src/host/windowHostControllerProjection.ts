...
import type { MesacodeArchivedTaskDeletionResult } from "@mesacode/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: MesacodeTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | MesacodeArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: MesacodeTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
