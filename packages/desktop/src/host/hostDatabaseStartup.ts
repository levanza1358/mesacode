import {
  ...
  resolveMesacodeAgentSpawnCwd,
} from "@mesacode/services/storage-startup";
import type { DatabaseStartupState } from "@mesacode/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveMesacodeAgentSpawnCwd({
