...
import type { IRemoteBackend } from "@mesacode/server/remote";
import type {
  IPromptAttachmentTransferService,
  PromptAttachmentStageResult,
  PromptAttachmentTransferProgress,
} from "@mesacode/services";
import type { MesacodePromptAttachment } from "@mesacode/shared";
import {
...
export function createRemotePromptAttachmentTransferService(
  ...
  return {
    async stage(params): Promise<PromptAttachmentStageResult> {
      ...
      const attachment: MesacodePromptAttachment = {
