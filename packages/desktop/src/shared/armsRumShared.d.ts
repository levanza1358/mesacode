import { type MesacodeRuntimeEnv } from "@mesacode/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: MesacodeRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@mesacode/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
