...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/mesacode-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
  ...
  define: {
    ...
    __MESACODE_VERSION__: JSON.stringify(version),
    __MESACODE_BUILTIN_PROVIDER_CONFIG_JSON__: JSON.stringify(mesacodeBuiltinProviderConfigJson),
  },
  metafile: true,
});

const remoteBundleSource = readFileSync("dist/remote/mesacode-server.cjs", "utf-8");
...
console.log("Built dist/remote/mesacode-server.cjs");
