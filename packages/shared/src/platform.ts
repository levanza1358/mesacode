...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "mesacode-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "mesacode-media";
...
export interface MesacodeStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleMesacodeStdioTapDevProxy: "toggleMesacodeStdioTapDevProxy",
  SetMesacodeEndpointProduction: "setMesacodeEndpointProduction",
  SetMesacodeEndpointTest: "setMesacodeEndpointTest",
  SetMesacodeEndpointCustom: "setMesacodeEndpointCustom",
  ResetMesacodeEndpoint: "resetMesacodeEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 Mesacode Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `mesacode://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.mesacode/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
