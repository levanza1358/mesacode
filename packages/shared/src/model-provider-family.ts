...
import { MESACODE_ENV } from "./env.js";
import { buildBigModelCodingPlanTeamManageUrl } from "./mesacodeEndpoint.js";
...
export const MODEL_PROVIDER_FAMILY_SPECS = [
  ...
  },
  {
    ...
    teamCodingPlanManageUrl: buildBigModelCodingPlanTeamManageUrl({ MESACODE_ENV }),
  },
