export type MesacodeAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly MesacodeAssistantMessagePart[] | undefined,
  nextPart: MesacodeAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly MesacodeAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly MesacodeAssistantMessagePart[]) {
