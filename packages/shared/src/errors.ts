...
export const MESACODE_FILE_LOCK_TIMEOUT_ERROR_CODE = "MESACODE_FILE_LOCK_TIMEOUT" as const;
...
export function isMesacodeFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === MESACODE_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
