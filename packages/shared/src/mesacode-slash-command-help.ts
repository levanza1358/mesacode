export type BuiltinMesacodeSlashCommandHelpEntry = {
...
export const BUILTIN_MESACODE_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinMesacodeSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    {
      details: ["Deletes Z.ai OAuth credentials from the shared Mesacode credential store."],
      name: "logout",
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.mesacode/AGENTS.md.",
      ],
      name: "init",
