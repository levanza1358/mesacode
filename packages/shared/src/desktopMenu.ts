...
export const desktopMenuMessageIds = {
  ...
  helpToggleMesacodeStdioTap: "titleBar.menu.help.toggleMesacodeStdioTap",
  helpMesacodeEndpoint: "titleBar.menu.help.mesacodeEndpoint",
  helpMesacodeEndpointProduction: "titleBar.menu.help.mesacodeEndpoint.production",
  helpMesacodeEndpointTest: "titleBar.menu.help.mesacodeEndpoint.test",
  helpMesacodeEndpointCustom: "titleBar.menu.help.mesacodeEndpoint.custom",
  helpMesacodeEndpointReset: "titleBar.menu.help.mesacodeEndpoint.reset",
  ...
  trayOpenMesacode: "tray.menu.openMesacode",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.about": "关于 Mesacode",
    ...
    "titleBar.menu.help.mesacodeEndpoint": "Mesacode Endpoint",
    "titleBar.menu.help.mesacodeEndpoint.production": "Production（默认）",
    "titleBar.menu.help.mesacodeEndpoint.test": "Test",
    "titleBar.menu.help.mesacodeEndpoint.custom": "自定义...",
    "titleBar.menu.help.mesacodeEndpoint.reset": "恢复默认",
    ...
    "tray.tooltip": "Mesacode",
    "tray.menu.openMesacode": "打开 Mesacode",
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.about": "About Mesacode",
    ...
    "titleBar.menu.help.mesacodeEndpoint": "Mesacode Endpoint",
    "titleBar.menu.help.mesacodeEndpoint.production": "Production (default)",
    "titleBar.menu.help.mesacodeEndpoint.test": "Test",
    "titleBar.menu.help.mesacodeEndpoint.custom": "Custom...",
    "titleBar.menu.help.mesacodeEndpoint.reset": "Reset to default",
    ...
    "tray.tooltip": "Mesacode",
    "tray.menu.openMesacode": "Open Mesacode",
    "tray.menu.quit": "Quit",
  },
};
