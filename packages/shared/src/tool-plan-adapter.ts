import type { MesacodePlanStep } from "./mesacode-task-types-core.js";
...
function normalizePlanStatus(value: unknown): MesacodePlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): MesacodePlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): MesacodePlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is MesacodePlanStep => step !== null);
