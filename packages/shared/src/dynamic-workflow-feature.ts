 ...
 */
export const MESACODE_DYNAMIC_WORKFLOW_MODE_ENV = "MESACODE_DYNAMIC_WORKFLOW_MODE";
...
export function resolveDynamicWorkflowClientConfig(input: {
  ...
  const override = normalizeDynamicWorkflowMode(input.env?.[MESACODE_DYNAMIC_WORKFLOW_MODE_ENV]);
