import { z } from "zod";
import { mesacodeSyntheticUserMessageSourceSchema } from "../mesacode-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: mesacodeSyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "mesacode", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../mesacode-task-types-core.js").MesacodeBackgroundTurnAttribution;
