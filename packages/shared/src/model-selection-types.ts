export const MESACODE_AGENT_PROVIDER_NOT_READY_CODE = "MESACODE_AGENT_PROVIDER_NOT_READY" as const;
export const MESACODE_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
