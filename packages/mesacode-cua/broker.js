...
export const BROKER_SOCKET_ENV = "MESACODE_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "MESACODE_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `mesacode-cua-broker-${randomUUID()}.sock`);
}
