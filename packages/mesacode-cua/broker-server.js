...
export const HELPER_ADDON_ENV = "MESACODE_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "mesacode-cua-windows-dev/v1";
...
export function isPotentialMesacodeCuaAgentMcpServer(_server) {
  return false;
}
